...
```
cd existing_repo
git remote add origin https://gitlab.alfameg.it/developteam/ispra-team/halemodels.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.alfameg.it/developteam/ispra-team/halemodels/-/settings/integrations)
